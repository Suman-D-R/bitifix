          ...
          <div className='mt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              ...
              <div className='text-center p-6 rounded-lg '>
                ...
                <p className='text-gray-300 text-sm'>
                  We deploy and configure your infrastructure with security and
                  performance in mind.
                </p>
              </div>
              <div className='text-center p-6 rounded-lg '>
                ...
                <p className='text-gray-300 text-sm'>
                  We integrate all components and thoroughly test the system for
                  reliability.
                </p>
              </div>
              <div className='text-center p-6 rounded-lg '>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20'>
            <div className='flex flex-col justify-center'>
              ...
              <p className='text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg leading-relaxed'>
                ...
                solutions. We integrate cutting-edge automation technologies to
                reduce manual work, improve efficiency, and accelerate your
          ...
          <div className='mt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              <div className='text-center p-6 rounded-lg '>
                ...
                <h4 className='text-lg font-semibold mb-2'>Process Analysis</h4>
                <p className='text-gray-300 text-sm'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20'>
            ...
            <div className='order-1 lg:order-2 flex flex-col justify-center'>
              ...
              <p className='text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg leading-relaxed'>
                ...
                99.9% uptime, advanced security, and expert support to keep your
                digital presence running smoothly.
              </p>
          ...
          <div className='mt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              ...
              <div className='text-center p-6 rounded-lg '>
                ...
                <p className='text-gray-300 text-sm'>
                  We configure and optimize servers for maximum performance and
                  security.
                </p>
              </div>
              <div className='text-center p-6 rounded-lg '>
                ...
                <p className='text-gray-300 text-sm'>
                  We implement security measures and monitoring systems for your
                  peace of mind.
                </p>
              </div>
              <div className='text-center p-6 rounded-lg '>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12 sm:mb-16'>
            ...
            <p className='text-sm sm:text-base md:text-lg text-gray-300 max-w-3xl mx-auto'>
              Beyond our core services, we offer comprehensive digital solutions
              including automation integration, web hosting, and specialized
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div className='text-center p-6 rounded-lg  transition-all duration-300 '>
              ...
              <h3 className='text-lg sm:text-xl font-bold mb-3'>Web Hosting</h3>
              <p className='text-gray-300 text-sm sm:text-base'>
