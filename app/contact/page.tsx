...
export default function ContactPage() {
  ...
  const contactStructuredData = {
    ...
    '@type': 'ContactPage',
    name: 'Contact Bitifix',
    description:
      'Get in touch with Bitifix for web development, mobile app development, and digital solutions consultation.',
    mainEntity: {
      '@type': 'Organization',
      name: 'Bitifix',
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 px-4 sm:px-0'>
                ...
                can help transform your ideas into exceptional digital
                solutions.
              </p>
            </div>
          </div>
            ...
            <div className='space-y-4 sm:space-y-6'>
              ...
              <div className='bg-[#111] rounded-lg p-4 sm:p-6 border border-white/10'>
                ...
                <p className='text-gray-300 text-sm sm:text-base leading-relaxed'>
                  ...
                  to keep your digital solutions running smoothly. This includes
              ...
              <div className='bg-[#111] rounded-lg p-4 sm:p-6 border border-white/10'>
                ...
                <p className='text-gray-300 text-sm sm:text-base leading-relaxed'>
                  ...
                  Node.js, Python, React Native, Flutter, and more. We choose
                  the best technology stack based on your project requirements.
                </p>
              </div>
