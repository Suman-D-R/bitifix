...
export default function BlogPost() {
  ...
  const articleStructuredData = {
    ...
    image: currentPost.image || '/images/og-blog-default.jpg',
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://bitifix.com/images/logo.svg',
      },
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://bitifix.com/blog/${currentPost.id}`,
    },
    url: `https://bitifix.com/blog/${currentPost.id}`,
